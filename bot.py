...
async def NewParliamentReal(context):
    ...
    if Berechtigung == False:
        ...
        AnzahlKriege, GesamtDamage, RawDmg, PerDmg, partydon, Gesamtspendenvolumen = await rrDamage.NewParliament(
            stateids, listwars, parteiliste, days, profildict, marktdict)
